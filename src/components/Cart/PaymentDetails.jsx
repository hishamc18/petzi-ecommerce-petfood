...
import Modal from "react-modal"; //modal for payment and
import { useNavigate } from "react-router-dom";
import { FaCheckCircle } from "react-icons/fa"; //icon
import { FiLoader } from "react-icons/fi"; //icon
import { SiGooglepay } from "react-icons/si"; //icon
import { FaAmazonPay, FaPaypal } from "react-icons/fa"; //icon
import { FaRegCreditCard } from "react-icons/fa6"; //icon
...
const PaymentDetails = () => {
    ...
    //total price accumuated using reduce
    ...
    //modal for payment, loading, summary
    const openModal = () => {
        setIsModalOpen(true);
        setIsLoading(false);
        setIsSuccess(false);
    ...
    const handlePayment = () => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setCart([]); //clearing cart after order
