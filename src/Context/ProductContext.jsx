...
// //     // clearing complete wishlist
// //     const clearWishlist = async () => {
// //         setWishList([]);
// //         await updateUserWishlistInDB([]);
// //     };

// //     //fn used to wishlist into DB
...
// //     //update qty of items in cart and db
...
// //     //for order details with a id(current date) and date
// //     const currentDate = new Date();
...
// //         saveOrder(orderWithIdandDate); //passing order orderdetails into saveOrder fn()
// //         setTimeout(() => {
// //             clearCartAfterOrder();
// //         }, 3000);
// //     };
...
// //     //for saving order history in db and state for orders-history page
...
//         const savedOrderSummary = localStorage.getItem("orderSummary");
//         return savedOrderSummary ? JSON.parse(savedOrderSummary) : null;
//     });
//     const [orders, setOrders] = useState([]);
//     const [toastMessage, setToastMessage] = useState("");
//     const navigate = useNavigate();
...
//         if (savedUsername) {
//             login(savedUsername); // Automatically log in the user
//         }
//     }, []);
...
//     // Set order details and save to localStorage
//     const setOrderDetails = (details) => {
//         const currentDate = new Date();
//         const formattedDate = currentDate.toISOString().slice(0, 10);
//         const orderWithIdandDate = {
...
//             date: formattedDate,
//         };
//         setOrderSummary(orderWithIdandDate); // Update the context state
//         localStorage.setItem("orderSummary", JSON.stringify(orderWithIdandDate)); // Save to localStorage
//         saveOrder(orderWithIdandDate); // Save order to DB
//         setTimeout(() => {
//             clearCartAfterOrder(); // Clear cart after order
//         }, 3000);
//     };
...
//     // Automatically update localStorage whenever orderSummary changes
//     useEffect(() => {
//         if (orderSummary) {
